/*
  ...
  gengetopt --file-name=cmdline1 --unamed-opts 
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -i, --allow-iosolated      Allow isolated base-pairs  (default=off)",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->allow_iosolated_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->allow_iosolated_flag = 0;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->allow_iosolated_given)
    write_into_file(outfile, "allow-iosolated", 0, 0 );
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'i':	/* Allow isolated base-pairs.  */
          ...
          if (update_arg((void *)&(args_info->allow_iosolated_flag), 0, &(args_info->allow_iosolated_given),
              &(local_args_info.allow_iosolated_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "allow-iosolated", 'i',
              additional_error))
            goto failure;
